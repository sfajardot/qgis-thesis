...
from .glaciotools_dialog import GlacioToolsDialog
import os.path
...
class GlacioTools:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&GlacioTools')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GlacioTools', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/glaciotools/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Process glacier data'),
            callback=self.run,
